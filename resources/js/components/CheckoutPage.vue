    ...
    <div><section class="checkout-page">
        <div class="checkout-form">
            ...
            <form novalidate @submit.prevent="placeOrder">
                ...
                <details open><summary><span>3</span> Payment Method <small v-if="Number(data.store.advance_payment_discount) > 0" class="payment-discount-note">{{ formatPrice(data.store.advance_payment_discount) }} off with advance payment</small></summary>
...
watch(() => form.payment_method, (method) => { state.paymentMethod = method; }, { immediate: true });
